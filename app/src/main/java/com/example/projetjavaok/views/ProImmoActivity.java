...
public class ProImmoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pro_immo);


        LoginButton = (Button) findViewById(R.id.login_btn);
        InputPassword = (TextInputLayout) findViewById(R.id.login_password_input);
        InputPhoneNumber = (TextInputLayout) findViewById(R.id.login_phone_number_input);
        ...
        compte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent julia = new Intent(ProImmoActivity.this,RegisterActivity.class);
                startActivity(julia);
            }
        });
                        ...
                        if (dataSnapshot.child(parentDbName).child(phone).exists()){
                            ...
                            if (usersData.getPhone().equals(phone))
                            {
                                if (usersData.getPassword().equals(password))
                                {
                                    ...
                                    {
                                        Toast.makeText(ProImmoActivity.this, "Bienvenue Admin, vous êtes connecté avec succès...", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();

                                        Intent intent = new Intent(ProImmoActivity.this,HomeAdminActivity.class);
                                        startActivity(intent);
                                    }
                                    else if (parentDbName.equals("Users")){
                                        Toast.makeText(ProImmoActivity.this, "Connecté avec succès...", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();

                                        Intent intent = new Intent(ProImmoActivity.this, HomeActivity.class);
                                    ...
                                    loadingBar.dismiss();
                                    Toast.makeText(ProImmoActivity.this,"Le mot de passe est incorrect veuillez ressayer svp",Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                        else {
                            Toast.makeText(ProImmoActivity.this, "Compte avec ça " + phone + " le numéro n'existe pas.", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
